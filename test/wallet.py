...
#   c) node1 mines 32 blocks, so now node 0 has 60001SPDZ, node 1 has 4250SPDZ, node2 has none.
#   d) node0 sends 601 SPDZ to node2, in two transactions (301 SPDZ, then 300 SPDZ).
