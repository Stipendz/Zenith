...
FORMS += src/qt/forms/addressbookpage.ui \
         src/qt/forms/askpassSPDZasedialog.ui \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/askpassSPDZasedialog.cpp \
...
RESOURCES += src/qt/SPDZ.qrc src/qt/SPDZ_locale.qrc

TRANSLATIONS += src/qt/locale/SPDZ_bg.ts \
                src/qt/locale/SPDZ_de.ts \
                src/qt/locale/SPDZ_en.ts \
                src/qt/locale/SPDZ_es.ts \
                src/qt/locale/SPDZ_fi.ts \
                src/qt/locale/SPDZ_fr.ts \
                src/qt/locale/SPDZ_it.ts \
                src/qt/locale/SPDZ_ja.ts \
                src/qt/locale/SPDZ_pl.ts \
                src/qt/locale/SPDZ_pt.ts \
                src/qt/locale/SPDZ_ru.ts \
                src/qt/locale/SPDZ_sk.ts \
                src/qt/locale/SPDZ_sv.ts \
                src/qt/locale/SPDZ_vi.ts \
                src/qt/locale/SPDZ_zh_CN.ts \
                src/qt/locale/SPDZ_zh_TW.ts
