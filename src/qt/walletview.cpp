...
void WalletView::encryptWallet(bool status)
{
    if (!walletModel)
        return;
    AskPassSPDZaseDialog dlg(status ? AskPassSPDZaseDialog::Encrypt : AskPassSPDZaseDialog::Decrypt, this, walletModel);
    dlg.exec();
...
void WalletView::changePassSPDZase()
{
    AskPassSPDZaseDialog dlg(AskPassSPDZaseDialog::ChangePass, this, walletModel);
    dlg.exec();
}
...
void WalletView::unlockWallet()
{
    ...
    if (walletModel->getEncryptionStatus() == WalletModel::Locked || walletModel->getEncryptionStatus() == WalletModel::UnlockedForAnonymizationOnly) {
        AskPassSPDZaseDialog dlg(AskPassSPDZaseDialog::UnlockAnonymize, this, walletModel);
        dlg.exec();
    }
}
