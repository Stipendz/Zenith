...
public:
    ...
    void setzSPDZControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzSPDZ_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSPDZ_clicked();
    void on_pushButtonzSPDZControl_clicked();
