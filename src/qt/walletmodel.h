...
public:
    ...
    // Wallet encryption
    bool setWalletEncrypted(bool encrypted, const SecureString& passSPDZase);
    // PassSPDZase only needed when unlocking
    bool setWalletLocked(bool locked, const SecureString& passSPDZase = SecureString(), bool anonymizeOnly = false);
    bool changePassSPDZase(const SecureString& oldPass, const SecureString& newPass);
