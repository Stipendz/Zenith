 ...
 */
    ...
    typeWidget->addItem(tr("Received SPDZ from zSPDZ"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSPDZ"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSPDZ));
