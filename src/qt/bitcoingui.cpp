                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SPDZ Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SPDZ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SPDZ: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSPDZ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SPDZ Core"), this);
    aboutAction->setStatusTip(tr("Show information about SPDZ Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SPDZ"));
    ...
    changePassSPDZaseAction = new QAction(QIcon(":/icons/key"), tr("&Change PassSPDZase..."), this);
    changePassSPDZaseAction->setStatusTip(tr("Change the passSPDZase used for wallet encryption"));
    unlockWalletAction = new QAction(tr("&Unlock Wallet..."), this);
    unlockWalletAction->setToolTip(tr("Unlock wallet"));
    lockWalletAction = new QAction(tr("&Lock Wallet"), this);
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your SPDZ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SPDZ addresses"));
    bip38ToolAction = new QAction(QIcon(":/icons/key"), tr("&BIP38 tool"), this);
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passSPDZase"));
    ...
    openAction->setStatusTip(tr("Open a SPDZ: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SPDZ Core help message to get a list with possible SPDZ command-line options"));
    ...
    if (walletFrame) {
        ...
        connect(changePassSPDZaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePassSPDZase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePassSPDZaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePassSPDZaseAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SPDZ Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SPDZ network", "", count));
}
...
{
    QString strTitle = tr("SPDZ Core"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePassSPDZaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePassSPDZaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
