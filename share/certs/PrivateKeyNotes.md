...
The key and certificate is in a separate, passSPDZase-protected keychain file that is
...
The key and certificate were exported into a separate, passSPDZase-protected PKCS#12 file, and
...
install a keylogger to get the passSPDZase that protects them.
