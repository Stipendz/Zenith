Contributing to SPDZ Core
============================

The SPDZ Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SPDZ Core project, and is not to be
confused with overall SPDZ Network Protocol consensus changes.

Whether a pull request is merged into SPDZ Core rests with the project merge
...
Patches that change SPDZ consensus rules are considerably more involved than
...
Where a patch set proposes to change the SPDZ consensus, it must have been
...
The project leader is the release manager for each SPDZ Core release.
