...
In order to support loading of multiple wallets in SPDZ-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is SPDZ.cpp.
...
Changes to SPDZ.cpp
----------------------
SPDZ.cpp is the entry point into SPDZ-qt, and as such, will require some minor modifications to provide hooks for
